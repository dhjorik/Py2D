    ...
    def draw_world(self):
        ...
        while x < self.level_width:
            ...
            if i % MAP_Cols:
                ...
                pygame.draw.rect(self.game_layer, 'red', (x-1, self.level_min_y,  3, self.level_max_y))
                # pygame.draw.line(self.game_layer, 'red', (x, self.level_min_y), (x, self.level_max_y))
