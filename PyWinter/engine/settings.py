...
# SCREEN_RES = SCREEN_W, SCREEN_H = 800, 600
...
ActorStateNames = {t: t.name.lower() for t in ActorState}

PLAYER_WALK_TIME = 4    # Number of seconds to go from 0 to WIDTH
